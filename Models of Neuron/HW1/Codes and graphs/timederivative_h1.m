function dPdt=timederivative_2(P)
...
k23=  kappa*T/h * exp(-1/(R*T) * (G3 - G2 + (z*1e-3*F*P(4)/4)))*100;
k32=  kappa*T/h * exp(-1/(R*T) * (G3 -      (z*1e-3*F*P(4)/4)))*100;

dPdt = [k21 * P(2) - k12 * P(1);...%dP1/dt
        k12 * P(1) + k32 * P(3) - (k21+k23) * P(2);...%dP2/dt
        k23 * P(2) - k32 * P(3);...%dP3/dt
        -(P(3) * Gisingle3 + P(2) * Gisingle2)* N  *(P(4)-E)/Cm];%%dV/dt 